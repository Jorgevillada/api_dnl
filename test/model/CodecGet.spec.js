...
(function(root, factory) {
  ...
  describe('CodecGet', function() {
    it('should create an instance of CodecGet', function() {
      // uncomment below and update the code to test CodecGet
      //var instane = new DnlApi.CodecGet();
      //expect(instance).to.be.a(DnlApi.CodecGet);
    });
