...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.CarrierTemplate();
  });
  ...
  describe('CarrierTemplate', function() {
    it('should create an instance of CarrierTemplate', function() {
      // uncomment below and update the code to test CarrierTemplate
      //var instane = new DnlApi.CarrierTemplate();
      //expect(instance).to.be.a(DnlApi.CarrierTemplate);
    });
