...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.IngressTrunk();
  });
  ...
  describe('IngressTrunk', function() {
    it('should create an instance of IngressTrunk', function() {
      // uncomment below and update the code to test IngressTrunk
      //var instane = new DnlApi.IngressTrunk();
      //expect(instance).to.be.a(DnlApi.IngressTrunk);
    });
