...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.TrunkTemplateGet();
  });
  ...
  describe('TrunkTemplateGet', function() {
    it('should create an instance of TrunkTemplateGet', function() {
      // uncomment below and update the code to test TrunkTemplateGet
      //var instane = new DnlApi.TrunkTemplateGet();
      //expect(instance).to.be.a(DnlApi.TrunkTemplateGet);
    });
