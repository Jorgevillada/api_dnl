...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.EgressProfile();
  });
  ...
  describe('EgressProfile', function() {
    it('should create an instance of EgressProfile', function() {
      // uncomment below and update the code to test EgressProfile
      //var instane = new DnlApi.EgressProfile();
      //expect(instance).to.be.a(DnlApi.EgressProfile);
    });
