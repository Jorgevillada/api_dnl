...
(function(root, factory) {
  ...
  describe('Failover', function() {
    it('should create an instance of Failover', function() {
      // uncomment below and update the code to test Failover
      //var instane = new DnlApi.Failover();
      //expect(instance).to.be.a(DnlApi.Failover);
    });
