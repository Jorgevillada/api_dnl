...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.GlobalFailoverModify();
  });
  ...
  describe('GlobalFailoverModify', function() {
    it('should create an instance of GlobalFailoverModify', function() {
      // uncomment below and update the code to test GlobalFailoverModify
      //var instane = new DnlApi.GlobalFailoverModify();
      //expect(instance).to.be.a(DnlApi.GlobalFailoverModify);
    });
