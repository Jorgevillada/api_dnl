...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.DailyCdrFieldAutoMini();
  });
  ...
  describe('DailyCdrFieldAutoMini', function() {
    it('should create an instance of DailyCdrFieldAutoMini', function() {
      // uncomment below and update the code to test DailyCdrFieldAutoMini
      //var instane = new DnlApi.DailyCdrFieldAutoMini();
      //expect(instance).to.be.a(DnlApi.DailyCdrFieldAutoMini);
    });
