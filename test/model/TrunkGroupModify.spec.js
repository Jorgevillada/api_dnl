...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.TrunkGroupModify();
  });
  ...
  describe('TrunkGroupModify', function() {
    it('should create an instance of TrunkGroupModify', function() {
      // uncomment below and update the code to test TrunkGroupModify
      //var instane = new DnlApi.TrunkGroupModify();
      //expect(instance).to.be.a(DnlApi.TrunkGroupModify);
    });
