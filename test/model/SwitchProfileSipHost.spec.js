...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.SwitchProfileSipHost();
  });
  ...
  describe('SwitchProfileSipHost', function() {
    it('should create an instance of SwitchProfileSipHost', function() {
      // uncomment below and update the code to test SwitchProfileSipHost
      //var instane = new DnlApi.SwitchProfileSipHost();
      //expect(instance).to.be.a(DnlApi.SwitchProfileSipHost);
    });
