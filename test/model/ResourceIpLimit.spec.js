...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ResourceIpLimit();
  });
  ...
  describe('ResourceIpLimit', function() {
    it('should create an instance of ResourceIpLimit', function() {
      // uncomment below and update the code to test ResourceIpLimit
      //var instane = new DnlApi.ResourceIpLimit();
      //expect(instance).to.be.a(DnlApi.ResourceIpLimit);
    });
