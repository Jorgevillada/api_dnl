...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.TrunkTemplate();
  });
  ...
  describe('TrunkTemplate', function() {
    it('should create an instance of TrunkTemplate', function() {
      // uncomment below and update the code to test TrunkTemplate
      //var instane = new DnlApi.TrunkTemplate();
      //expect(instance).to.be.a(DnlApi.TrunkTemplate);
    });
