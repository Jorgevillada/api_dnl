...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.DynamicRoutePri();
  });
  ...
  describe('DynamicRoutePri', function() {
    it('should create an instance of DynamicRoutePri', function() {
      // uncomment below and update the code to test DynamicRoutePri
      //var instane = new DnlApi.DynamicRoutePri();
      //expect(instance).to.be.a(DnlApi.DynamicRoutePri);
    });
