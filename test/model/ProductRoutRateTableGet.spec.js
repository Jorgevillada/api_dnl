...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ProductRoutRateTableGet();
  });
  ...
  describe('ProductRoutRateTableGet', function() {
    it('should create an instance of ProductRoutRateTableGet', function() {
      // uncomment below and update the code to test ProductRoutRateTableGet
      //var instane = new DnlApi.ProductRoutRateTableGet();
      //expect(instance).to.be.a(DnlApi.ProductRoutRateTableGet);
    });
