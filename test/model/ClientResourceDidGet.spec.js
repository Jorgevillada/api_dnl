...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ClientResourceDidGet();
  });
  ...
  describe('ClientResourceDidGet', function() {
    it('should create an instance of ClientResourceDidGet', function() {
      // uncomment below and update the code to test ClientResourceDidGet
      //var instane = new DnlApi.ClientResourceDidGet();
      //expect(instance).to.be.a(DnlApi.ClientResourceDidGet);
    });
