...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.CodeDeckGet();
  });
  ...
  describe('CodeDeckGet', function() {
    it('should create an instance of CodeDeckGet', function() {
      // uncomment below and update the code to test CodeDeckGet
      //var instane = new DnlApi.CodeDeckGet();
      //expect(instance).to.be.a(DnlApi.CodeDeckGet);
    });
