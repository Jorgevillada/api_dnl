...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.SendRateDirectModify();
  });
  ...
  describe('SendRateDirectModify', function() {
    it('should create an instance of SendRateDirectModify', function() {
      // uncomment below and update the code to test SendRateDirectModify
      //var instane = new DnlApi.SendRateDirectModify();
      //expect(instance).to.be.a(DnlApi.SendRateDirectModify);
    });
