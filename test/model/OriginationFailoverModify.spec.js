...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.OriginationFailoverModify();
  });
  ...
  describe('OriginationFailoverModify', function() {
    it('should create an instance of OriginationFailoverModify', function() {
      // uncomment below and update the code to test OriginationFailoverModify
      //var instane = new DnlApi.OriginationFailoverModify();
      //expect(instance).to.be.a(DnlApi.OriginationFailoverModify);
    });
