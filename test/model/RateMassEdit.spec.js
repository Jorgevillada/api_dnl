...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.RateMassEdit();
  });
  ...
  describe('RateMassEdit', function() {
    it('should create an instance of RateMassEdit', function() {
      // uncomment below and update the code to test RateMassEdit
      //var instane = new DnlApi.RateMassEdit();
      //expect(instance).to.be.a(DnlApi.RateMassEdit);
    });
    ...
    it('should have the property rateIdList (base name: "rate_id_list")', function() {
      // uncomment below and update the code to test the property rateIdList
      //var instane = new DnlApi.RateMassEdit();
      //expect(instance).to.be();
    });
