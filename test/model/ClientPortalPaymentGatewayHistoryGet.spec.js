...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ClientPortalPaymentGatewayHistoryGet();
  });
  ...
  describe('ClientPortalPaymentGatewayHistoryGet', function() {
    it('should create an instance of ClientPortalPaymentGatewayHistoryGet', function() {
      // uncomment below and update the code to test ClientPortalPaymentGatewayHistoryGet
      //var instane = new DnlApi.ClientPortalPaymentGatewayHistoryGet();
      //expect(instance).to.be.a(DnlApi.ClientPortalPaymentGatewayHistoryGet);
    });
