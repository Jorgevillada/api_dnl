...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.RateGenerationTemplate();
  });
  ...
  describe('RateGenerationTemplate', function() {
    it('should create an instance of RateGenerationTemplate', function() {
      // uncomment below and update the code to test RateGenerationTemplate
      //var instane = new DnlApi.RateGenerationTemplate();
      //expect(instance).to.be.a(DnlApi.RateGenerationTemplate);
    });
