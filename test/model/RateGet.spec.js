...
(function(root, factory) {
  ...
  describe('RateGet', function() {
    it('should create an instance of RateGet', function() {
      // uncomment below and update the code to test RateGet
      //var instane = new DnlApi.RateGet();
      //expect(instance).to.be.a(DnlApi.RateGet);
    });
