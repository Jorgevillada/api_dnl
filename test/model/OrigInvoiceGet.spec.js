...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.OrigInvoiceGet();
  });
  ...
  describe('OrigInvoiceGet', function() {
    it('should create an instance of OrigInvoiceGet', function() {
      // uncomment below and update the code to test OrigInvoiceGet
      //var instane = new DnlApi.OrigInvoiceGet();
      //expect(instance).to.be.a(DnlApi.OrigInvoiceGet);
    });
