...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.CurrencyGet();
  });
  ...
  describe('CurrencyGet', function() {
    it('should create an instance of CurrencyGet', function() {
      // uncomment below and update the code to test CurrencyGet
      //var instane = new DnlApi.CurrencyGet();
      //expect(instance).to.be.a(DnlApi.CurrencyGet);
    });
