...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.CarrierGroup();
  });
  ...
  describe('CarrierGroup', function() {
    it('should create an instance of CarrierGroup', function() {
      // uncomment below and update the code to test CarrierGroup
      //var instane = new DnlApi.CarrierGroup();
      //expect(instance).to.be.a(DnlApi.CarrierGroup);
    });
