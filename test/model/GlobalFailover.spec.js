...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.GlobalFailover();
  });
  ...
  describe('GlobalFailover', function() {
    it('should create an instance of GlobalFailover', function() {
      // uncomment below and update the code to test GlobalFailover
      //var instane = new DnlApi.GlobalFailover();
      //expect(instance).to.be.a(DnlApi.GlobalFailover);
    });
