...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.TrunkGroupGet();
  });
  ...
  describe('TrunkGroupGet', function() {
    it('should create an instance of TrunkGroupGet', function() {
      // uncomment below and update the code to test TrunkGroupGet
      //var instane = new DnlApi.TrunkGroupGet();
      //expect(instance).to.be.a(DnlApi.TrunkGroupGet);
    });
    ...
    it('should have the property trunksCount (base name: "trunks_count")', function() {
      // uncomment below and update the code to test the property trunksCount
      //var instane = new DnlApi.TrunkGroupGet();
      //expect(instance).to.be();
    });
