...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.AlertRuleGet();
  });
  ...
  describe('AlertRuleGet', function() {
    it('should create an instance of AlertRuleGet', function() {
      // uncomment below and update the code to test AlertRuleGet
      //var instane = new DnlApi.AlertRuleGet();
      //expect(instance).to.be.a(DnlApi.AlertRuleGet);
    });
    ...
    it('should have the property nextRunTime (base name: "next_run_time")', function() {
