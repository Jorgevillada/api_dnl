...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.SendRateDirectGet();
  });
  ...
  describe('SendRateDirectGet', function() {
    it('should create an instance of SendRateDirectGet', function() {
      // uncomment below and update the code to test SendRateDirectGet
      //var instane = new DnlApi.SendRateDirectGet();
      //expect(instance).to.be.a(DnlApi.SendRateDirectGet);
    });
