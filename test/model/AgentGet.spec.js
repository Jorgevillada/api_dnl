...
(function(root, factory) {
  ...
  describe('AgentGet', function() {
    it('should create an instance of AgentGet', function() {
      // uncomment below and update the code to test AgentGet
      //var instane = new DnlApi.AgentGet();
      //expect(instance).to.be.a(DnlApi.AgentGet);
    });
