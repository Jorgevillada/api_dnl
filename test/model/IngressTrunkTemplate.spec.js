...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.IngressTrunkTemplate();
  });
  ...
  describe('IngressTrunkTemplate', function() {
    it('should create an instance of IngressTrunkTemplate', function() {
      // uncomment below and update the code to test IngressTrunkTemplate
      //var instane = new DnlApi.IngressTrunkTemplate();
      //expect(instance).to.be.a(DnlApi.IngressTrunkTemplate);
    });
