...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ResourceSimple();
  });
  ...
  describe('ResourceSimple', function() {
    it('should create an instance of ResourceSimple', function() {
      // uncomment below and update the code to test ResourceSimple
      //var instane = new DnlApi.ResourceSimple();
      //expect(instance).to.be.a(DnlApi.ResourceSimple);
    });
