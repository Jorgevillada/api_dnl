...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ClientResourceDid();
  });
  ...
  describe('ClientResourceDid', function() {
    it('should create an instance of ClientResourceDid', function() {
      // uncomment below and update the code to test ClientResourceDid
      //var instane = new DnlApi.ClientResourceDid();
      //expect(instance).to.be.a(DnlApi.ClientResourceDid);
    });
