...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.CarrierTemplateModify();
  });
  ...
  describe('CarrierTemplateModify', function() {
    it('should create an instance of CarrierTemplateModify', function() {
      // uncomment below and update the code to test CarrierTemplateModify
      //var instane = new DnlApi.CarrierTemplateModify();
      //expect(instance).to.be.a(DnlApi.CarrierTemplateModify);
    });
