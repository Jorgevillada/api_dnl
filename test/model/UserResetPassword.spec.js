...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.UserResetPassword();
  });
  ...
  describe('UserResetPassword', function() {
    it('should create an instance of UserResetPassword', function() {
      // uncomment below and update the code to test UserResetPassword
      //var instane = new DnlApi.UserResetPassword();
      //expect(instance).to.be.a(DnlApi.UserResetPassword);
    });
