...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.LoopDetection();
  });
  ...
  describe('LoopDetection', function() {
    it('should create an instance of LoopDetection', function() {
      // uncomment below and update the code to test LoopDetection
      //var instane = new DnlApi.LoopDetection();
      //expect(instance).to.be.a(DnlApi.LoopDetection);
    });
