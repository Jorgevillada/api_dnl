...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.FtpConfGet();
  });
  ...
  describe('FtpConfGet', function() {
    it('should create an instance of FtpConfGet', function() {
      // uncomment below and update the code to test FtpConfGet
      //var instane = new DnlApi.FtpConfGet();
      //expect(instance).to.be.a(DnlApi.FtpConfGet);
    });
