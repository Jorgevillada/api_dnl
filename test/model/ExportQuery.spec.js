...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ExportQuery();
  });
  ...
  describe('ExportQuery', function() {
    it('should create an instance of ExportQuery', function() {
      // uncomment below and update the code to test ExportQuery
      //var instane = new DnlApi.ExportQuery();
      //expect(instance).to.be.a(DnlApi.ExportQuery);
    });
