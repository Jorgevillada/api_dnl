...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.RateUploadTaskGet();
  });
  ...
  describe('RateUploadTaskGet', function() {
    it('should create an instance of RateUploadTaskGet', function() {
      // uncomment below and update the code to test RateUploadTaskGet
      //var instane = new DnlApi.RateUploadTaskGet();
      //expect(instance).to.be.a(DnlApi.RateUploadTaskGet);
    });
