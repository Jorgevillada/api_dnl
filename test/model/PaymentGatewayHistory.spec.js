...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.PaymentGatewayHistory();
  });
  ...
  describe('PaymentGatewayHistory', function() {
    it('should create an instance of PaymentGatewayHistory', function() {
      // uncomment below and update the code to test PaymentGatewayHistory
      //var instane = new DnlApi.PaymentGatewayHistory();
      //expect(instance).to.be.a(DnlApi.PaymentGatewayHistory);
    });
    ...
    it('should have the property clientNameamount (base name: "client_nameamount")', function() {
      // uncomment below and update the code to test the property clientNameamount
      //var instane = new DnlApi.PaymentGatewayHistory();
      //expect(instance).to.be();
    });
