...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.SignupModify();
  });
  ...
  describe('SignupModify', function() {
    it('should create an instance of SignupModify', function() {
      // uncomment below and update the code to test SignupModify
      //var instane = new DnlApi.SignupModify();
      //expect(instance).to.be.a(DnlApi.SignupModify);
    });
