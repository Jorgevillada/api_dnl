...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.CarrierLong();
  });
  ...
  describe('CarrierLong', function() {
    it('should create an instance of CarrierLong', function() {
      // uncomment below and update the code to test CarrierLong
      //var instane = new DnlApi.CarrierLong();
      //expect(instance).to.be.a(DnlApi.CarrierLong);
    });
