...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.RateModify2();
  });
  ...
  describe('RateModify2', function() {
    it('should create an instance of RateModify2', function() {
      // uncomment below and update the code to test RateModify2
      //var instane = new DnlApi.RateModify2();
      //expect(instance).to.be.a(DnlApi.RateModify2);
    });
