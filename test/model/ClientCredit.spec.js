...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ClientCredit();
  });
  ...
  describe('ClientCredit', function() {
    it('should create an instance of ClientCredit', function() {
      // uncomment below and update the code to test ClientCredit
      //var instane = new DnlApi.ClientCredit();
      //expect(instance).to.be.a(DnlApi.ClientCredit);
    });
