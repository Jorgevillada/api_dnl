...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.VendorResourceDid();
  });
  ...
  describe('VendorResourceDid', function() {
    it('should create an instance of VendorResourceDid', function() {
      // uncomment below and update the code to test VendorResourceDid
      //var instane = new DnlApi.VendorResourceDid();
      //expect(instance).to.be.a(DnlApi.VendorResourceDid);
    });
