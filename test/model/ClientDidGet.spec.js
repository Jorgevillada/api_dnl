...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ClientDidGet();
  });
  ...
  describe('ClientDidGet', function() {
    it('should create an instance of ClientDidGet', function() {
      // uncomment below and update the code to test ClientDidGet
      //var instane = new DnlApi.ClientDidGet();
      //expect(instance).to.be.a(DnlApi.ClientDidGet);
    });
