...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.VoipGatewayGet();
  });
  ...
  describe('VoipGatewayGet', function() {
    it('should create an instance of VoipGatewayGet', function() {
      // uncomment below and update the code to test VoipGatewayGet
      //var instane = new DnlApi.VoipGatewayGet();
      //expect(instance).to.be.a(DnlApi.VoipGatewayGet);
    });
