...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.SendRateDirect();
  });
  ...
  describe('SendRateDirect', function() {
    it('should create an instance of SendRateDirect', function() {
      // uncomment below and update the code to test SendRateDirect
      //var instane = new DnlApi.SendRateDirect();
      //expect(instance).to.be.a(DnlApi.SendRateDirect);
    });
