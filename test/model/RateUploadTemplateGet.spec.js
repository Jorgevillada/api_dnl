...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.RateUploadTemplateGet();
  });
  ...
  describe('RateUploadTemplateGet', function() {
    it('should create an instance of RateUploadTemplateGet', function() {
      // uncomment below and update the code to test RateUploadTemplateGet
      //var instane = new DnlApi.RateUploadTemplateGet();
      //expect(instance).to.be.a(DnlApi.RateUploadTemplateGet);
    });
