...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.DynamicRouteOver();
  });
  ...
  describe('DynamicRouteOver', function() {
    it('should create an instance of DynamicRouteOver', function() {
      // uncomment below and update the code to test DynamicRouteOver
      //var instane = new DnlApi.DynamicRouteOver();
      //expect(instance).to.be.a(DnlApi.DynamicRouteOver);
    });
