...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.VendorDidGet();
  });
  ...
  describe('VendorDidGet', function() {
    it('should create an instance of VendorDidGet', function() {
      // uncomment below and update the code to test VendorDidGet
      //var instane = new DnlApi.VendorDidGet();
      //expect(instance).to.be.a(DnlApi.VendorDidGet);
    });
