...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ProductItemsGet();
  });
  ...
  describe('ProductItemsGet', function() {
    it('should create an instance of ProductItemsGet', function() {
      // uncomment below and update the code to test ProductItemsGet
      //var instane = new DnlApi.ProductItemsGet();
      //expect(instance).to.be.a(DnlApi.ProductItemsGet);
    });
