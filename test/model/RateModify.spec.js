...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.RateModify();
  });
  ...
  describe('RateModify', function() {
    it('should create an instance of RateModify', function() {
      // uncomment below and update the code to test RateModify
      //var instane = new DnlApi.RateModify();
      //expect(instance).to.be.a(DnlApi.RateModify);
    });
