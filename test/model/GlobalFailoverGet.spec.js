...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.GlobalFailoverGet();
  });
  ...
  describe('GlobalFailoverGet', function() {
    it('should create an instance of GlobalFailoverGet', function() {
      // uncomment below and update the code to test GlobalFailoverGet
      //var instane = new DnlApi.GlobalFailoverGet();
      //expect(instance).to.be.a(DnlApi.GlobalFailoverGet);
    });
