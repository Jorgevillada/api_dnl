...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.IngressTrunkTemplateGet();
  });
  ...
  describe('IngressTrunkTemplateGet', function() {
    it('should create an instance of IngressTrunkTemplateGet', function() {
      // uncomment below and update the code to test IngressTrunkTemplateGet
      //var instane = new DnlApi.IngressTrunkTemplateGet();
      //expect(instance).to.be.a(DnlApi.IngressTrunkTemplateGet);
    });
