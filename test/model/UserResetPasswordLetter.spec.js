...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.UserResetPasswordLetter();
  });
  ...
  describe('UserResetPasswordLetter', function() {
    it('should create an instance of UserResetPasswordLetter', function() {
      // uncomment below and update the code to test UserResetPasswordLetter
      //var instane = new DnlApi.UserResetPasswordLetter();
      //expect(instance).to.be.a(DnlApi.UserResetPasswordLetter);
    });
