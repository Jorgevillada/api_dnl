...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.PaymentGatewayHistoryGet();
  });
  ...
  describe('PaymentGatewayHistoryGet', function() {
    it('should create an instance of PaymentGatewayHistoryGet', function() {
      // uncomment below and update the code to test PaymentGatewayHistoryGet
      //var instane = new DnlApi.PaymentGatewayHistoryGet();
      //expect(instance).to.be.a(DnlApi.PaymentGatewayHistoryGet);
    });
