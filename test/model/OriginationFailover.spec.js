...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.OriginationFailover();
  });
  ...
  describe('OriginationFailover', function() {
    it('should create an instance of OriginationFailover', function() {
      // uncomment below and update the code to test OriginationFailover
      //var instane = new DnlApi.OriginationFailover();
      //expect(instance).to.be.a(DnlApi.OriginationFailover);
    });
