...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.DynamicRouteOverGet();
  });
  ...
  describe('DynamicRouteOverGet', function() {
    it('should create an instance of DynamicRouteOverGet', function() {
      // uncomment below and update the code to test DynamicRouteOverGet
      //var instane = new DnlApi.DynamicRouteOverGet();
      //expect(instance).to.be.a(DnlApi.DynamicRouteOverGet);
    });
