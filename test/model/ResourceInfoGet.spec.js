...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DnlApi.ResourceInfoGet();
  });
  ...
  describe('ResourceInfoGet', function() {
    it('should create an instance of ResourceInfoGet', function() {
      // uncomment below and update the code to test ResourceInfoGet
      //var instane = new DnlApi.ResourceInfoGet();
      //expect(instance).to.be.a(DnlApi.ResourceInfoGet);
    });
