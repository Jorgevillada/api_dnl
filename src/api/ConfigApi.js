...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AttributeNotExists', 'model/CarrierTemplate', 'model/DailyCdrField', 'model/DailyCdrFieldAutoEditMany', 'model/DailyCdrFieldEditMany', 'model/ExportCreate', 'model/FtpConf', 'model/GlobalFailover', 'model/GlobalFailoverMany', 'model/GlobalRouteError', 'model/InlineResponse20033', 'model/InlineResponse20034', 'model/InlineResponse20035', 'model/InlineResponse20036', 'model/InlineResponse20037', 'model/InlineResponse20038', 'model/InlineResponse20039', 'model/InlineResponse20040', 'model/InlineResponse20041', 'model/InlineResponse20042', 'model/InlineResponse20043', 'model/InlineResponse20044', 'model/InlineResponse20045', 'model/InlineResponse20046', 'model/InlineResponse20047', 'model/InlineResponse20048', 'model/InlineResponse20049', 'model/InlineResponse20050', 'model/InlineResponse20051', 'model/InlineResponse20052', 'model/InlineResponse20053', 'model/InlineResponse20054', 'model/InlineResponse20055', 'model/InlineResponse20056', 'model/InlineResponse20057', 'model/InlineResponse20058', 'model/InlineResponse20059', 'model/InlineResponse20060', 'model/InlineResponse20061', 'model/InlineResponse20062', 'model/InlineResponse20063', 'model/InlineResponse20064', 'model/InlineResponse20065', 'model/InlineResponse20066', 'model/InlineResponse20067', 'model/InlineResponse20068', 'model/InlineResponse20069', 'model/InlineResponse20070', 'model/InlineResponse20071', 'model/JurisdictionPrefix', 'model/MailSender', 'model/MailSenderTest', 'model/MailTemplate', 'model/ObjectCreated', 'model/ObjectNotFoundError', 'model/OperationError', 'model/OriginationFailover', 'model/OriginationFailoverMany', 'model/PaymentTerm', 'model/ResourceFromTemplate', 'model/Role', 'model/RolePrivilege', 'model/SendRateTemplate', 'model/Success', 'model/SystemFunction', 'model/SystemParameterInvoiceSetting', 'model/SystemParameterLoginPage', 'model/SystemParameterPaymentSetting', 'model/SystemParameterSystemSetting', 'model/TerminationFailover', 'model/TerminationFailoverMany', 'model/TimeProfile', 'model/TrunkTemplate', 'model/UnauthenticatedError', 'model/ValidationError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AttributeNotExists'), require('../model/CarrierTemplate'), require('../model/DailyCdrField'), require('../model/DailyCdrFieldAutoEditMany'), require('../model/DailyCdrFieldEditMany'), require('../model/ExportCreate'), require('../model/FtpConf'), require('../model/GlobalFailover'), require('../model/GlobalFailoverMany'), require('../model/GlobalRouteError'), require('../model/InlineResponse20033'), require('../model/InlineResponse20034'), require('../model/InlineResponse20035'), require('../model/InlineResponse20036'), require('../model/InlineResponse20037'), require('../model/InlineResponse20038'), require('../model/InlineResponse20039'), require('../model/InlineResponse20040'), require('../model/InlineResponse20041'), require('../model/InlineResponse20042'), require('../model/InlineResponse20043'), require('../model/InlineResponse20044'), require('../model/InlineResponse20045'), require('../model/InlineResponse20046'), require('../model/InlineResponse20047'), require('../model/InlineResponse20048'), require('../model/InlineResponse20049'), require('../model/InlineResponse20050'), require('../model/InlineResponse20051'), require('../model/InlineResponse20052'), require('../model/InlineResponse20053'), require('../model/InlineResponse20054'), require('../model/InlineResponse20055'), require('../model/InlineResponse20056'), require('../model/InlineResponse20057'), require('../model/InlineResponse20058'), require('../model/InlineResponse20059'), require('../model/InlineResponse20060'), require('../model/InlineResponse20061'), require('../model/InlineResponse20062'), require('../model/InlineResponse20063'), require('../model/InlineResponse20064'), require('../model/InlineResponse20065'), require('../model/InlineResponse20066'), require('../model/InlineResponse20067'), require('../model/InlineResponse20068'), require('../model/InlineResponse20069'), require('../model/InlineResponse20070'), require('../model/InlineResponse20071'), require('../model/JurisdictionPrefix'), require('../model/MailSender'), require('../model/MailSenderTest'), require('../model/MailTemplate'), require('../model/ObjectCreated'), require('../model/ObjectNotFoundError'), require('../model/OperationError'), require('../model/OriginationFailover'), require('../model/OriginationFailoverMany'), require('../model/PaymentTerm'), require('../model/ResourceFromTemplate'), require('../model/Role'), require('../model/RolePrivilege'), require('../model/SendRateTemplate'), require('../model/Success'), require('../model/SystemFunction'), require('../model/SystemParameterInvoiceSetting'), require('../model/SystemParameterLoginPage'), require('../model/SystemParameterPaymentSetting'), require('../model/SystemParameterSystemSetting'), require('../model/TerminationFailover'), require('../model/TerminationFailoverMany'), require('../model/TimeProfile'), require('../model/TrunkTemplate'), require('../model/UnauthenticatedError'), require('../model/ValidationError'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.ConfigApi = factory(root.DnlApi.ApiClient, root.DnlApi.AttributeNotExists, root.DnlApi.CarrierTemplate, root.DnlApi.DailyCdrField, root.DnlApi.DailyCdrFieldAutoEditMany, root.DnlApi.DailyCdrFieldEditMany, root.DnlApi.ExportCreate, root.DnlApi.FtpConf, root.DnlApi.GlobalFailover, root.DnlApi.GlobalFailoverMany, root.DnlApi.GlobalRouteError, root.DnlApi.InlineResponse20033, root.DnlApi.InlineResponse20034, root.DnlApi.InlineResponse20035, root.DnlApi.InlineResponse20036, root.DnlApi.InlineResponse20037, root.DnlApi.InlineResponse20038, root.DnlApi.InlineResponse20039, root.DnlApi.InlineResponse20040, root.DnlApi.InlineResponse20041, root.DnlApi.InlineResponse20042, root.DnlApi.InlineResponse20043, root.DnlApi.InlineResponse20044, root.DnlApi.InlineResponse20045, root.DnlApi.InlineResponse20046, root.DnlApi.InlineResponse20047, root.DnlApi.InlineResponse20048, root.DnlApi.InlineResponse20049, root.DnlApi.InlineResponse20050, root.DnlApi.InlineResponse20051, root.DnlApi.InlineResponse20052, root.DnlApi.InlineResponse20053, root.DnlApi.InlineResponse20054, root.DnlApi.InlineResponse20055, root.DnlApi.InlineResponse20056, root.DnlApi.InlineResponse20057, root.DnlApi.InlineResponse20058, root.DnlApi.InlineResponse20059, root.DnlApi.InlineResponse20060, root.DnlApi.InlineResponse20061, root.DnlApi.InlineResponse20062, root.DnlApi.InlineResponse20063, root.DnlApi.InlineResponse20064, root.DnlApi.InlineResponse20065, root.DnlApi.InlineResponse20066, root.DnlApi.InlineResponse20067, root.DnlApi.InlineResponse20068, root.DnlApi.InlineResponse20069, root.DnlApi.InlineResponse20070, root.DnlApi.InlineResponse20071, root.DnlApi.JurisdictionPrefix, root.DnlApi.MailSender, root.DnlApi.MailSenderTest, root.DnlApi.MailTemplate, root.DnlApi.ObjectCreated, root.DnlApi.ObjectNotFoundError, root.DnlApi.OperationError, root.DnlApi.OriginationFailover, root.DnlApi.OriginationFailoverMany, root.DnlApi.PaymentTerm, root.DnlApi.ResourceFromTemplate, root.DnlApi.Role, root.DnlApi.RolePrivilege, root.DnlApi.SendRateTemplate, root.DnlApi.Success, root.DnlApi.SystemFunction, root.DnlApi.SystemParameterInvoiceSetting, root.DnlApi.SystemParameterLoginPage, root.DnlApi.SystemParameterPaymentSetting, root.DnlApi.SystemParameterSystemSetting, root.DnlApi.TerminationFailover, root.DnlApi.TerminationFailoverMany, root.DnlApi.TimeProfile, root.DnlApi.TrunkTemplate, root.DnlApi.UnauthenticatedError, root.DnlApi.ValidationError);
  }
}(this, function(ApiClient, AttributeNotExists, CarrierTemplate, DailyCdrField, DailyCdrFieldAutoEditMany, DailyCdrFieldEditMany, ExportCreate, FtpConf, GlobalFailover, GlobalFailoverMany, GlobalRouteError, InlineResponse20033, InlineResponse20034, InlineResponse20035, InlineResponse20036, InlineResponse20037, InlineResponse20038, InlineResponse20039, InlineResponse20040, InlineResponse20041, InlineResponse20042, InlineResponse20043, InlineResponse20044, InlineResponse20045, InlineResponse20046, InlineResponse20047, InlineResponse20048, InlineResponse20049, InlineResponse20050, InlineResponse20051, InlineResponse20052, InlineResponse20053, InlineResponse20054, InlineResponse20055, InlineResponse20056, InlineResponse20057, InlineResponse20058, InlineResponse20059, InlineResponse20060, InlineResponse20061, InlineResponse20062, InlineResponse20063, InlineResponse20064, InlineResponse20065, InlineResponse20066, InlineResponse20067, InlineResponse20068, InlineResponse20069, InlineResponse20070, InlineResponse20071, JurisdictionPrefix, MailSender, MailSenderTest, MailTemplate, ObjectCreated, ObjectNotFoundError, OperationError, OriginationFailover, OriginationFailoverMany, PaymentTerm, ResourceFromTemplate, Role, RolePrivilege, SendRateTemplate, Success, SystemFunction, SystemParameterInvoiceSetting, SystemParameterLoginPage, SystemParameterPaymentSetting, SystemParameterSystemSetting, TerminationFailover, TerminationFailoverMany, TimeProfile, TrunkTemplate, UnauthenticatedError, ValidationError) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} id CarrierTemplate id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/CarrierTemplate} opts.body CarrierTemplate to modify
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TrunkTemplate} opts.body EgressTrunkTemplate to create
     ...
     * @param {Number} resourceTemplateId EgressTrunkTemplate id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/TrunkTemplate} opts.body EgressTrunkTemplate to modify
    ...
    this.configExportIdGet = function(id, callback) {
      ...
      var authNames = ['auth_token'];
      var contentTypes = ['application/json'];
      var accepts = ['application/json', 'image/png', 'text/csv'];
      var returnType = InlineResponse20033;
     ...
     * @param {Number} id GlobalFailover id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/GlobalFailover} opts.body GlobalFailover to modify
    ...
    /**
     * Callback function to receive the result of the configFailoverOriginationCreatePost operation.
     * @callback module:api/ConfigApi~configFailoverOriginationCreatePostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ObjectCreated} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/OriginationFailover} opts.body OriginationFailover to create
     * @param {module:api/ConfigApi~configFailoverOriginationCreatePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ObjectCreated}
     */
    this.configFailoverOriginationCreatePost = function(opts, callback) {
      opts = opts || {};
      var postBody = opts['body'];
      ...
      return this.apiClient.callApi(
        '/config/failover/origination/create', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the configFailoverOriginationIdDelete operation.
     * @callback module:api/ConfigApi~configFailoverOriginationIdDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Success} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ConfigApi~configFailoverOriginationIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Success}
     */
    this.configFailoverOriginationIdDelete = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling configFailoverOriginationIdDelete");
      }
      ...
      return this.apiClient.callApi(
        '/config/failover/origination/{id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @param {Number} id OriginationFailover id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/OriginationFailover} opts.body OriginationFailover to modify
    ...
    /**
     * Callback function to receive the result of the configFailoverTerminationCreatePost operation.
     * @callback module:api/ConfigApi~configFailoverTerminationCreatePostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ObjectCreated} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TerminationFailover} opts.body TerminationFailover to create
     * @param {module:api/ConfigApi~configFailoverTerminationCreatePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ObjectCreated}
     */
    this.configFailoverTerminationCreatePost = function(opts, callback) {
      opts = opts || {};
      var postBody = opts['body'];
      ...
      return this.apiClient.callApi(
        '/config/failover/termination/create', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the configFailoverTerminationIdDelete operation.
     * @callback module:api/ConfigApi~configFailoverTerminationIdDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Success} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ConfigApi~configFailoverTerminationIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Success}
     */
    this.configFailoverTerminationIdDelete = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling configFailoverTerminationIdDelete");
      }
      ...
      return this.apiClient.callApi(
        '/config/failover/termination/{id}', 'DELETE',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @param {Number} id TerminationFailover id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/TerminationFailover} opts.body TerminationFailover to modify
     ...
     * data is of type: {@link module:model/ObjectCreated}
     */
    this.configImportPost = function(entity, format, file, callback) {
      var postBody = null;
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TrunkTemplate} opts.body IngressTrunkTemplate to create
     ...
     * @param {Number} resourceTemplateId IngressTrunkTemplate id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/TrunkTemplate} opts.body IngressTrunkTemplate to modify
     ...
     * @param {Number} id MailSender id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/MailSender} opts.body MailSender to modify
    ...
    /**
     * Callback function to receive the result of the configRouteErrorCreatePost operation.
     * @callback module:api/ConfigApi~configRouteErrorCreatePostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ObjectCreated} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/GlobalRouteError} opts.body GlobalRouteError to create
     * @param {module:api/ConfigApi~configRouteErrorCreatePostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ObjectCreated}
     */
    this.configRouteErrorCreatePost = function(opts, callback) {
      opts = opts || {};
      var postBody = opts['body'];
      ...
      return this.apiClient.callApi(
        '/config/route_error/create', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the configRouteErrorIdDelete operation.
     * @callback module:api/ConfigApi~configRouteErrorIdDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Success} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ConfigApi~configRouteErrorIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Success}
     */
    this.configRouteErrorIdDelete = function(id, callback) {
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling configRouteErrorIdDelete");
      }
     ...
     * @param {Number} id GlobalRouteError id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/GlobalRouteError} opts.body GlobalRouteError to modify
     ...
     * @param {Number} id SendRateTemplate id to get info about
     * @param {Object} opts Optional parameters
     * @param {module:model/SendRateTemplate} opts.body SendRateTemplate to modify
