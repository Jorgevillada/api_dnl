...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AttributeNotExists', 'model/InlineResponse200132', 'model/InlineResponse200133', 'model/InlineResponse200134', 'model/ObjectCreated', 'model/ObjectNotFoundError', 'model/OperationError', 'model/ProductRoutRateTable', 'model/Success', 'model/UnauthenticatedError', 'model/ValidationError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AttributeNotExists'), require('../model/InlineResponse200132'), require('../model/InlineResponse200133'), require('../model/InlineResponse200134'), require('../model/ObjectCreated'), require('../model/ObjectNotFoundError'), require('../model/OperationError'), require('../model/ProductRoutRateTable'), require('../model/Success'), require('../model/UnauthenticatedError'), require('../model/ValidationError'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.ProductApi = factory(root.DnlApi.ApiClient, root.DnlApi.AttributeNotExists, root.DnlApi.InlineResponse200132, root.DnlApi.InlineResponse200133, root.DnlApi.InlineResponse200134, root.DnlApi.ObjectCreated, root.DnlApi.ObjectNotFoundError, root.DnlApi.OperationError, root.DnlApi.ProductRoutRateTable, root.DnlApi.Success, root.DnlApi.UnauthenticatedError, root.DnlApi.ValidationError);
  }
}(this, function(ApiClient, AttributeNotExists, InlineResponse200132, InlineResponse200133, InlineResponse200134, ObjectCreated, ObjectNotFoundError, OperationError, ProductRoutRateTable, Success, UnauthenticatedError, ValidationError) {
  'use strict';
