...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AttributeNotExists', 'model/CodeAll', 'model/CodeDeck', 'model/Currency', 'model/InlineResponse200176', 'model/InlineResponse200177', 'model/InlineResponse200178', 'model/InlineResponse200179', 'model/InlineResponse200180', 'model/InlineResponse200181', 'model/InlineResponse200182', 'model/InlineResponse200183', 'model/InlineResponse200184', 'model/InlineResponse200185', 'model/InlineResponse200186', 'model/InlineResponse200187', 'model/InlineResponse200188', 'model/InlineResponse200189', 'model/InlineResponse200190', 'model/InlineResponse200191', 'model/InlineResponse200192', 'model/InlineResponse2002', 'model/ObjectCreated', 'model/ObjectNotFoundError', 'model/OperationError', 'model/Rate', 'model/RateMany', 'model/RateMassEdit', 'model/RateModify', 'model/RateSendToClients', 'model/RateTable', 'model/RateTableCopy', 'model/Success', 'model/SwitchProfileModify', 'model/SwitchProfileSipHost', 'model/UnauthenticatedError', 'model/ValidationError', 'model/VoipGateway'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AttributeNotExists'), require('../model/CodeAll'), require('../model/CodeDeck'), require('../model/Currency'), require('../model/InlineResponse200176'), require('../model/InlineResponse200177'), require('../model/InlineResponse200178'), require('../model/InlineResponse200179'), require('../model/InlineResponse200180'), require('../model/InlineResponse200181'), require('../model/InlineResponse200182'), require('../model/InlineResponse200183'), require('../model/InlineResponse200184'), require('../model/InlineResponse200185'), require('../model/InlineResponse200186'), require('../model/InlineResponse200187'), require('../model/InlineResponse200188'), require('../model/InlineResponse200189'), require('../model/InlineResponse200190'), require('../model/InlineResponse200191'), require('../model/InlineResponse200192'), require('../model/InlineResponse2002'), require('../model/ObjectCreated'), require('../model/ObjectNotFoundError'), require('../model/OperationError'), require('../model/Rate'), require('../model/RateMany'), require('../model/RateMassEdit'), require('../model/RateModify'), require('../model/RateSendToClients'), require('../model/RateTable'), require('../model/RateTableCopy'), require('../model/Success'), require('../model/SwitchProfileModify'), require('../model/SwitchProfileSipHost'), require('../model/UnauthenticatedError'), require('../model/ValidationError'), require('../model/VoipGateway'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.SwitchApi = factory(root.DnlApi.ApiClient, root.DnlApi.AttributeNotExists, root.DnlApi.CodeAll, root.DnlApi.CodeDeck, root.DnlApi.Currency, root.DnlApi.InlineResponse200176, root.DnlApi.InlineResponse200177, root.DnlApi.InlineResponse200178, root.DnlApi.InlineResponse200179, root.DnlApi.InlineResponse200180, root.DnlApi.InlineResponse200181, root.DnlApi.InlineResponse200182, root.DnlApi.InlineResponse200183, root.DnlApi.InlineResponse200184, root.DnlApi.InlineResponse200185, root.DnlApi.InlineResponse200186, root.DnlApi.InlineResponse200187, root.DnlApi.InlineResponse200188, root.DnlApi.InlineResponse200189, root.DnlApi.InlineResponse200190, root.DnlApi.InlineResponse200191, root.DnlApi.InlineResponse200192, root.DnlApi.InlineResponse2002, root.DnlApi.ObjectCreated, root.DnlApi.ObjectNotFoundError, root.DnlApi.OperationError, root.DnlApi.Rate, root.DnlApi.RateMany, root.DnlApi.RateMassEdit, root.DnlApi.RateModify, root.DnlApi.RateSendToClients, root.DnlApi.RateTable, root.DnlApi.RateTableCopy, root.DnlApi.Success, root.DnlApi.SwitchProfileModify, root.DnlApi.SwitchProfileSipHost, root.DnlApi.UnauthenticatedError, root.DnlApi.ValidationError, root.DnlApi.VoipGateway);
  }
}(this, function(ApiClient, AttributeNotExists, CodeAll, CodeDeck, Currency, InlineResponse200176, InlineResponse200177, InlineResponse200178, InlineResponse200179, InlineResponse200180, InlineResponse200181, InlineResponse200182, InlineResponse200183, InlineResponse200184, InlineResponse200185, InlineResponse200186, InlineResponse200187, InlineResponse200188, InlineResponse200189, InlineResponse200190, InlineResponse200191, InlineResponse200192, InlineResponse2002, ObjectCreated, ObjectNotFoundError, OperationError, Rate, RateMany, RateMassEdit, RateModify, RateSendToClients, RateTable, RateTableCopy, Success, SwitchProfileModify, SwitchProfileSipHost, UnauthenticatedError, ValidationError, VoipGateway) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the switchCodeAllDelete operation.
     * @callback module:api/SwitchApi~switchCodeAllDeleteCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/SwitchApi~switchCodeAllDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2002}
     */
    this.switchCodeAllDelete = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the switchCodeDeckAllDelete operation.
     * @callback module:api/SwitchApi~switchCodeDeckAllDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2002} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.codeCount 
     * @param {Number} opts.codeDeckId 
     * @param {String} opts.codeDeckIdIn 
     * @param {String} opts.name 
     * @param {String} opts.updateBy 
     * @param {String} opts.updateOnGte 
     * @param {String} opts.updateOnLt 
     * @param {Number} opts.usageCount 
     * @param {module:api/SwitchApi~switchCodeDeckAllDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2002}
     */
    this.switchCodeDeckAllDelete = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      var queryParams = {
        'code_count': opts['codeCount'],
        'code_deck_id': opts['codeDeckId'],
        'code_deck_id_in': opts['codeDeckIdIn'],
        'name': opts['name'],
    ...
    /**
     * Callback function to receive the result of the switchRateAllDelete operation.
     * @callback module:api/SwitchApi~switchRateAllDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2002} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.rateIdIn 
     * @param {String} opts.rateLt 
     * @param {Number} opts.timeProfileId 
     * @param {module:api/SwitchApi~switchRateAllDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2002}
     */
    this.switchRateAllDelete = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the switchRateTableAllDelete operation.
     * @callback module:api/SwitchApi~switchRateTableAllDeleteCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2002} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.rateTableIdIn 
     * @param {String} opts.rateTypeName 
     * @param {String} opts.updateAtGt 
     * @param {String} opts.updateAtLt 
     * @param {Number} opts.usageCountGt 
     * @param {module:api/SwitchApi~switchRateTableAllDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2002}
     */
    this.switchRateTableAllDelete = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      var queryParams = {
        ...
        'rate_table_id_in': opts['rateTableIdIn'],
    ...
    /**
     * Callback function to receive the result of the switchRateTableRateTableIdCopyPost operation.
     * @callback module:api/SwitchApi~switchRateTableRateTableIdCopyPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ObjectCreated} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} rateTableId Rate table to copy
     * @param {Object} opts Optional parameters
     * @param {module:model/RateTableCopy} opts.body RateTable copy to create
     * @param {module:api/SwitchApi~switchRateTableRateTableIdCopyPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ObjectCreated}
     */
    this.switchRateTableRateTableIdCopyPost = function(rateTableId, opts, callback) {
      opts = opts || {};
      var postBody = opts['body'];

      // verify the required parameter 'rateTableId' is set
      if (rateTableId === undefined || rateTableId === null) {
        throw new Error("Missing the required parameter 'rateTableId' when calling switchRateTableRateTableIdCopyPost");
      }
      ...
      return this.apiClient.callApi(
        '/switch/rate_table/{rate_table_id}/copy', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the switchRateTableRateTableIdMassEditPatch operation.
     * @callback module:api/SwitchApi~switchRateTableRateTableIdMassEditPatchCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} rateTableId Parent rate table
     * @param {Object} opts Optional parameters
     * @param {module:model/RateMassEdit} opts.body Mass edit action
     * @param {module:api/SwitchApi~switchRateTableRateTableIdMassEditPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse200191}
     */
    this.switchRateTableRateTableIdMassEditPatch = function(rateTableId, opts, callback) {
      opts = opts || {};
      var postBody = opts['body'];

      // verify the required parameter 'rateTableId' is set
      if (rateTableId === undefined || rateTableId === null) {
        throw new Error("Missing the required parameter 'rateTableId' when calling switchRateTableRateTableIdMassEditPatch");
      }
      ...
      return this.apiClient.callApi(
        '/switch/rate_table/{rate_table_id}/mass_edit', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Deletes voipgateway
     * @param {Number} switchId VoipGateway id to get info about
     ...
     * data is of type: {@link module:model/Success}
     */
    this.switchSwitchIdDelete = function(switchId, callback) {
      var postBody = null;
     ...
     */
    this.switchSwitchIdGet = function(switchId, callback) {
      var postBody = null;
     ...
     * data is of type: {@link module:model/InlineResponse200176}
     */
    this.switchSwitchIdPatch = function(switchId, opts, callback) {
      opts = opts || {};
      var postBody = opts['body'];

      // verify the required parameter 'switchId' is set
      if (switchId === undefined || switchId === null) {
        throw new Error("Missing the required parameter 'switchId' when calling switchSwitchIdPatch");
      }
    ...
    /**
     * Callback function to receive the result of the switchSwitchIdReloadPatch operation.
     * @callback module:api/SwitchApi~switchSwitchIdReloadPatchCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Success} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * 
     * @param {Number} switchId gateway id refresh
     * @param {module:api/SwitchApi~switchSwitchIdReloadPatchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Success}
     */
    this.switchSwitchIdReloadPatch = function(switchId, callback) {
      var postBody = null;

      // verify the required parameter 'switchId' is set
      if (switchId === undefined || switchId === null) {
        throw new Error("Missing the required parameter 'switchId' when calling switchSwitchIdReloadPatch");
      }
