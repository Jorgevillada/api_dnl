...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AttributeNotExists', 'model/InlineResponse200108', 'model/InlineResponse200135', 'model/UnauthenticatedError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AttributeNotExists'), require('../model/InlineResponse200108'), require('../model/InlineResponse200135'), require('../model/UnauthenticatedError'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.ReportsApi = factory(root.DnlApi.ApiClient, root.DnlApi.AttributeNotExists, root.DnlApi.InlineResponse200108, root.DnlApi.InlineResponse200135, root.DnlApi.UnauthenticatedError);
  }
}(this, function(ApiClient, AttributeNotExists, InlineResponse200108, InlineResponse200135, UnauthenticatedError) {
  'use strict';
