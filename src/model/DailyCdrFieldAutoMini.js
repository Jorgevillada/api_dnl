...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.DailyCdrFieldAutoMini = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The DailyCdrFieldAutoMini model module.
   * @module model/DailyCdrFieldAutoMini
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>DailyCdrFieldAutoMini</code>.
   * @alias module:model/DailyCdrFieldAutoMini
   * @class
   */
  ...
  /**
   * Constructs a <code>DailyCdrFieldAutoMini</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DailyCdrFieldAutoMini} obj Optional instance to populate.
   * @return {module:model/DailyCdrFieldAutoMini} The populated <code>DailyCdrFieldAutoMini</code> instance.
   */
