...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.ClientPortalPaymentGet = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The ClientPortalPaymentGet model module.
   * @module model/ClientPortalPaymentGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>ClientPortalPaymentGet</code>.
   * @alias module:model/ClientPortalPaymentGet
   * @class
   */
  ...
  /**
   * Constructs a <code>ClientPortalPaymentGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClientPortalPaymentGet} obj Optional instance to populate.
   * @return {module:model/ClientPortalPaymentGet} The populated <code>ClientPortalPaymentGet</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('balancenote')) {
        obj['balancenote'] = ApiClient.convertToType(data['balancenote'], 'String');
      }
  ...
  /**
   * @member {String} balancenote
   */
  exports.prototype['balancenote'] = undefined;
  /**
  ...
  /**
   * @member {module:model/ClientPortalPaymentGet.PaymentTypeNameEnum} payment_type_name
   * @default 'n/a'
   */
