...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.CarrierTemplateGet = factory(root.DnlApi.ApiClient, root.DnlApi.CarrierTemplateLowBalConfig);
  }
  ...
  /**
   * The CarrierTemplateGet model module.
   * @module model/CarrierTemplateGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>CarrierTemplateGet</code>.
   * @alias module:model/CarrierTemplateGet
   * @class
   */
  ...
  /**
   * Constructs a <code>CarrierTemplateGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarrierTemplateGet} obj Optional instance to populate.
   * @return {module:model/CarrierTemplateGet} The populated <code>CarrierTemplateGet</code> instance.
   */
  ...
  /**
   * @member {module:model/CarrierTemplateGet.ProfitTypeEnum} profit_type
   * @default 'percentage'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateGet.ModeEnum} mode
   * @default 'prepay'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateGet.FormatEnum} format
   * @default 'PDF'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateGet.SccTypeEnum} scc_type
  ...
  /**
   * @member {module:model/CarrierTemplateGet.AutoSummaryGroupByEnum} auto_summary_group_by
   * @default 'By Country'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateGet.CdrFormatEnum} cdr_format
   * @default 'Excel'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateGet.RateValueEnum} rate_value
   * @default 'null'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateGet.AutoDailyBalanceRecipientEnum} auto_daily_balance_recipient
