...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.EgressProfileGet = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The EgressProfileGet model module.
   * @module model/EgressProfileGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>EgressProfileGet</code>.
   * @alias module:model/EgressProfileGet
   * @class
   */
  ...
  /**
   * Constructs a <code>EgressProfileGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EgressProfileGet} obj Optional instance to populate.
   * @return {module:model/EgressProfileGet} The populated <code>EgressProfileGet</code> instance.
   */
