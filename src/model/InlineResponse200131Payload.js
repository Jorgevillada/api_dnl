...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OrigInvoice'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrigInvoice'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.InlineResponse200131Payload = factory(root.DnlApi.ApiClient, root.DnlApi.OrigInvoice);
  }
}(this, function(ApiClient, OrigInvoice) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [OrigInvoice]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/OrigInvoice>} items
   */
