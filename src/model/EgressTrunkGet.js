...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.EgressTrunkGet = factory(root.DnlApi.ApiClient, root.DnlApi.ResourceCodecsRefGet, root.DnlApi.ResourceIpAllGet, root.DnlApi.ResourceIpRegGatewayGet, root.DnlApi.ResourceIpRegUserGet, root.DnlApi.ResourcePrefixGet, root.DnlApi.ResourceTranslationRefGet);
  }
  ...
  /**
   * @member {module:model/EgressTrunkGet.AuthTypeEnum} auth_type
  ...
  /**
   * @member {module:model/EgressTrunkGet.RpidPrivacyEnum} rpid_privacy
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/EgressTrunkGet.TrunkType2Enum} trunk_type2
  ...
  /**
   * @member {module:model/EgressTrunkGet.UsOtherEnum} us_other
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/EgressTrunkGet.ServiceTypeEnum} service_type
  ...
  /**
   * @member {module:model/EgressTrunkGet.RpidPartyEnum} rpid_party
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/EgressTrunkGet.CliTypeEnum} cli_type
   * @default 'white'
   */
  exports.prototype['cli_type'] = 'white';
  /**
   * @member {module:model/EgressTrunkGet.AuthorizationTypeEnum} authorization_type
   * @default 'Authorized by Host Only'
   */
  ...
  /**
   * @member {module:model/EgressTrunkGet.BillingMethodEnum} billing_method
   * @default 'by minutes'
   */
  ...
  /**
   * @member {module:model/EgressTrunkGet.JurisdictionUseDnisEnum} jurisdiction_use_dnis
   * @default 'LRN'
   */
  exports.prototype['jurisdiction_use_dnis'] = 'LRN';
  /**
   * @member {module:model/EgressTrunkGet.MediaTypeEnum} media_type
  ...
  /**
   * @member {module:model/EgressTrunkGet.PassThroughEnum} pass_through
   * @default 'transparent'
   */
  ...
  /**
   * @member {module:model/EgressTrunkGet.RpidEnum} rpid
   * @default 'Never'
   */
  ...
  /**
   * @member {module:model/EgressTrunkGet.RateRoundingEnum} rate_rounding
   * @default 'Up'
   */
  ...
  /**
   * @member {module:model/EgressTrunkGet.RpidScreenEnum} rpid_screen
   * @default 'None'
   */
