...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.GlobalFailoverGet = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The GlobalFailoverGet model module.
   * @module model/GlobalFailoverGet
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>GlobalFailoverGet</code>.
   * @alias module:model/GlobalFailoverGet
   * @class
   */
  ...
  /**
   * Constructs a <code>GlobalFailoverGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GlobalFailoverGet} obj Optional instance to populate.
   * @return {module:model/GlobalFailoverGet} The populated <code>GlobalFailoverGet</code> instance.
   */
  ...
  /**
   * @member {module:model/GlobalFailoverGet.FailoverMethodEnum} failover_method
