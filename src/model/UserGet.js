...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.UserGet = factory(root.DnlApi.ApiClient, root.DnlApi.UsersLimit);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('client_limits')) {
        obj['client_limits'] = UsersLimit.constructFromObject(data['client_limits']);
      }
  ...
  /**
   * @member {module:model/UsersLimit} client_limits
   */
