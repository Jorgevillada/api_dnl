...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.RateModify = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The RateModify model module.
   * @module model/RateModify
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>RateModify</code>.
   * @alias module:model/RateModify
   * @class
   * @param rateTableId {Number} 
   * @param rate {Number} 
   * @param codeName {String} 
   */
  var exports = function(rateTableId, rate, codeName) {
    var _this = this;



    _this['rate_table_id'] = rateTableId;
  ...
  /**
   * Constructs a <code>RateModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RateModify} obj Optional instance to populate.
   * @return {module:model/RateModify} The populated <code>RateModify</code> instance.
   */
