...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.EgressTrunkTemplate = factory(root.DnlApi.ApiClient, root.DnlApi.TrunkTemplateIp);
  }
  ...
  /**
   * The EgressTrunkTemplate model module.
   * @module model/EgressTrunkTemplate
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>EgressTrunkTemplate</code>.
   * @alias module:model/EgressTrunkTemplate
   * @class
   */
  ...
  /**
   * Constructs a <code>EgressTrunkTemplate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EgressTrunkTemplate} obj Optional instance to populate.
   * @return {module:model/EgressTrunkTemplate} The populated <code>EgressTrunkTemplate</code> instance.
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.IntlRouteEnum} intl_route
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.ProfitTypeEnum} profit_type
   * @default 'percentage'
   */
  exports.prototype['profit_type'] = 'percentage';
  /**
   * @member {module:model/EgressTrunkTemplate.RpidPrivacyEnum} rpid_privacy
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.CanadaOtherEnum} canada_other
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.RpidPartyEnum} rpid_party
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.UsOtherEnum} us_other
   * @default 'other'
   */
  exports.prototype['us_other'] = 'other';
  /**
   * @member {module:model/EgressTrunkTemplate.TrunkType2Enum} trunk_type2
   * @default 'Termination Traffic'
   */
  exports.prototype['trunk_type2'] = 'Termination Traffic';
  /**
   * @member {module:model/EgressTrunkTemplate.ResStrategyEnum} res_strategy
   * @default 'top-down'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.TrunkTypeEnum} trunk_type
   * @default 'class4'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.RateRoundingEnum} rate_rounding
   * @default 'Up'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.MediaTypeEnum} media_type
   * @default 'Proxy Media + Transcoding'
   */
  exports.prototype['media_type'] = 'Proxy Media + Transcoding';
  /**
   * @member {module:model/EgressTrunkTemplate.RpidIdTypeEnum} rpid_id_type
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.CanadaRouteEnum} canada_route
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.UsRouteEnum} us_route
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/EgressTrunkTemplate.RpidScreenEnum} rpid_screen
   * @default 'None'
   */
