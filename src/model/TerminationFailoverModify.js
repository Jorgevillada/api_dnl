...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.TerminationFailoverModify = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The TerminationFailoverModify model module.
   * @module model/TerminationFailoverModify
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>TerminationFailoverModify</code>.
   * @alias module:model/TerminationFailoverModify
   * @class
   */
  ...
  /**
   * Constructs a <code>TerminationFailoverModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TerminationFailoverModify} obj Optional instance to populate.
   * @return {module:model/TerminationFailoverModify} The populated <code>TerminationFailoverModify</code> instance.
   */
  ...
  /**
   * @member {module:model/TerminationFailoverModify.FailoverMethodEnum} failover_method
