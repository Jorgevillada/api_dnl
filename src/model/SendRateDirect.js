...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.SendRateDirect = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The SendRateDirect model module.
   * @module model/SendRateDirect
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>SendRateDirect</code>.
   * @alias module:model/SendRateDirect
   * @class
   */
  ...
  /**
   * Constructs a <code>SendRateDirect</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendRateDirect} obj Optional instance to populate.
   * @return {module:model/SendRateDirect} The populated <code>SendRateDirect</code> instance.
   */
  ...
  /**
   * @member {module:model/SendRateDirect.DownloadMethodEnum} download_method
   * @default 'send as link'
   */
  exports.prototype['download_method'] = 'send as link';
  /**
   * @member {Array.<module:model/SendRateDirect.HeadersEnum>} headers
   */
