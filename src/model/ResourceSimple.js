...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.ResourceSimple = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The ResourceSimple model module.
   * @module model/ResourceSimple
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>ResourceSimple</code>.
   * @alias module:model/ResourceSimple
   * @class
   */
  ...
  /**
   * Constructs a <code>ResourceSimple</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResourceSimple} obj Optional instance to populate.
   * @return {module:model/ResourceSimple} The populated <code>ResourceSimple</code> instance.
   */
