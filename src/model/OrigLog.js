...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.OrigLog = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The OrigLog model module.
   * @module model/OrigLog
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>OrigLog</code>.
   * @alias module:model/OrigLog
   * @class
   */
  ...
  /**
   * Constructs a <code>OrigLog</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrigLog} obj Optional instance to populate.
   * @return {module:model/OrigLog} The populated <code>OrigLog</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('log_id')) {
        obj['log_id'] = ApiClient.convertToType(data['log_id'], 'Number');
      }
  ...
  /**
   * @member {module:model/OrigLog.TypeEnum} type
   * @default 'Creation'
   */
