...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.IngressTrunkTemplateGet = factory(root.DnlApi.ApiClient, root.DnlApi.TrunkTemplateIp);
  }
  ...
  /**
   * The IngressTrunkTemplateGet model module.
   * @module model/IngressTrunkTemplateGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>IngressTrunkTemplateGet</code>.
   * @alias module:model/IngressTrunkTemplateGet
   * @class
   */
  ...
  /**
   * Constructs a <code>IngressTrunkTemplateGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IngressTrunkTemplateGet} obj Optional instance to populate.
   * @return {module:model/IngressTrunkTemplateGet} The populated <code>IngressTrunkTemplateGet</code> instance.
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.IntlRouteEnum} intl_route
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.ProfitTypeEnum} profit_type
   * @default 'percentage'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.CanadaOtherEnum} canada_other
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.RpidPartyEnum} rpid_party
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.RpidPrivacyEnum} rpid_privacy
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.UsOtherEnum} us_other
   * @default 'other'
   */
  exports.prototype['us_other'] = 'other';
  /**
   * @member {module:model/IngressTrunkTemplateGet.TrunkType2Enum} trunk_type2
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.ResStrategyEnum} res_strategy
   * @default 'top-down'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.DirectionEnum} direction
   * @default 'ingress'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.TrunkTypeEnum} trunk_type
   * @default 'class4'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.RateRoundingEnum} rate_rounding
   * @default 'Up'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.MediaTypeEnum} media_type
   * @default 'Proxy Media + Transcoding'
   */
  exports.prototype['media_type'] = 'Proxy Media + Transcoding';
  /**
   * @member {module:model/IngressTrunkTemplateGet.RpidIdTypeEnum} rpid_id_type
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.CanadaRouteEnum} canada_route
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.UsRouteEnum} us_route
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet.RpidScreenEnum} rpid_screen
   * @default 'None'
   */
