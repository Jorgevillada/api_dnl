...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.InlineResponse20079 = factory(root.DnlApi.ApiClient, root.DnlApi.JurisdictionPrefixGet);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) {
        obj['payload'] = JurisdictionPrefixGet.constructFromObject(data['payload']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/JurisdictionPrefixGet} payload
   */
