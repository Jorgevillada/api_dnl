...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.RateUploadTemplateModify = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The RateUploadTemplateModify model module.
   * @module model/RateUploadTemplateModify
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>RateUploadTemplateModify</code>.
   * @alias module:model/RateUploadTemplateModify
   * @class
   */
  ...
  /**
   * Constructs a <code>RateUploadTemplateModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RateUploadTemplateModify} obj Optional instance to populate.
   * @return {module:model/RateUploadTemplateModify} The populated <code>RateUploadTemplateModify</code> instance.
   */
  ...
  /**
   * @member {module:model/RateUploadTemplateModify.EffectiveDateFormatEnum} effective_date_format
   */
  ...
  /**
   * @member {Array.<module:model/RateUploadTemplateModify.HeadersEnum>} headers
   */
  ...
  /**
   * @member {module:model/RateUploadTemplateModify.SendErrorEmailToEnum} send_error_email_to
   * @default 'none'
   */
  ...
  /**
   * @member {module:model/RateUploadTemplateModify.RejectRateEnum} reject_rate
   * @default 'no'
   */
  ...
  /**
   * @member {module:model/RateUploadTemplateModify.DupMethodEnum} dup_method
   * @default 'End-Date All Records'
   */
  exports.prototype['dup_method'] = 'End-Date All Records';
  /**
   * @member {module:model/RateUploadTemplateModify.CodeNameMatchEnum} code_name_match
