...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.TerminationFailover = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The TerminationFailover model module.
   * @module model/TerminationFailover
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>TerminationFailover</code>.
   * @alias module:model/TerminationFailover
   * @class
   */
  ...
  /**
   * Constructs a <code>TerminationFailover</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TerminationFailover} obj Optional instance to populate.
   * @return {module:model/TerminationFailover} The populated <code>TerminationFailover</code> instance.
   */
  ...
  /**
   * @member {module:model/TerminationFailover.FailoverMethodEnum} failover_method
