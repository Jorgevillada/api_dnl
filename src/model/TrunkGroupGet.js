...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.TrunkGroupGet = factory(root.DnlApi.ApiClient, root.DnlApi.ResourceInfoGet);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('trunks')) {
        obj['trunks'] = ApiClient.convertToType(data['trunks'], [ResourceInfoGet]);
      }
  ...
  /**
   * @member {Array.<module:model/ResourceInfoGet>} trunks
   */
