...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CodeCountry'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CodeCountry'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.InlineResponse20042Payload = factory(root.DnlApi.ApiClient, root.DnlApi.CodeCountry);
  }
}(this, function(ApiClient, CodeCountry) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [CodeCountry]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/CodeCountry>} items
   */
