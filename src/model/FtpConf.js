...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.FtpConf = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The FtpConf model module.
   * @module model/FtpConf
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>FtpConf</code>.
   * @alias module:model/FtpConf
   * @class
   */
  ...
  /**
   * Constructs a <code>FtpConf</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FtpConf} obj Optional instance to populate.
   * @return {module:model/FtpConf} The populated <code>FtpConf</code> instance.
   */
  ...
  /**
   * @member {module:model/FtpConf.CompressionEnum} compression
   * @default 'gz'
   */
  ...
  /**
   * @member {module:model/FtpConf.FrequencyEnum} frequency
   * @default 'daily'
   */
  ...
  /**
   * @member {module:model/FtpConf.FileBreakdownEnum} file_breakdown
