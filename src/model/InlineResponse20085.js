...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.InlineResponse20085 = factory(root.DnlApi.ApiClient, root.DnlApi.IngressTrunkTemplateGet);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) {
        obj['payload'] = IngressTrunkTemplateGet.constructFromObject(data['payload']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/IngressTrunkTemplateGet} payload
   */
