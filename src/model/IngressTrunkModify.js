...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.IngressTrunkModify = factory(root.DnlApi.ApiClient, root.DnlApi.ResourceCodecsRefGet, root.DnlApi.ResourceIp, root.DnlApi.ResourceIpRegGateway, root.DnlApi.ResourceIpRegUser, root.DnlApi.ResourcePrefixModify, root.DnlApi.ResourceTranslationRefGet);
  }
  ...
  /**
   * The IngressTrunkModify model module.
   * @module model/IngressTrunkModify
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>IngressTrunkModify</code>.
   * @alias module:model/IngressTrunkModify
   * @class
   */
  ...
  /**
   * Constructs a <code>IngressTrunkModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IngressTrunkModify} obj Optional instance to populate.
   * @return {module:model/IngressTrunkModify} The populated <code>IngressTrunkModify</code> instance.
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.AuthTypeEnum} auth_type
  ...
  /**
   * @member {module:model/IngressTrunkModify.RpidPrivacyEnum} rpid_privacy
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.AuthorizationTypeEnum} authorization_type
   * @default 'Authorized by Host Only'
   */
  exports.prototype['authorization_type'] = 'Authorized by Host Only';
  /**
   * @member {module:model/IngressTrunkModify.HostRoutingStrategyEnum} host_routing_strategy
   * @default 'top-down'
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.CliTypeEnum} cli_type
   * @default 'white'
   */
  exports.prototype['cli_type'] = 'white';
  /**
   * @member {module:model/IngressTrunkModify.RpidPartyEnum} rpid_party
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.UsOtherEnum} us_other
   * @default 'other'
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.MinProfitTypeEnum} min_profit_type
   * @default 'percentage'
   */
  exports.prototype['min_profit_type'] = 'percentage';
  /**
   * @member {module:model/IngressTrunkModify.ServiceTypeEnum} service_type
  ...
  /**
   * @member {module:model/IngressTrunkModify.TrunkType2Enum} trunk_type2
  ...
  /**
   * @member {module:model/IngressTrunkModify.BillingMethodEnum} billing_method
   * @default 'by minutes'
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.RateRoundingEnum} rate_rounding
   * @default 'Up'
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.JurisdictionUseDnisEnum} jurisdiction_use_dnis
   * @default 'LRN'
   */
  exports.prototype['jurisdiction_use_dnis'] = 'LRN';
  /**
   * @member {module:model/IngressTrunkModify.MediaTypeEnum} media_type
   * @default 'Proxy Media + Transcoding'
   */
  exports.prototype['media_type'] = 'Proxy Media + Transcoding';
  /**
   * @member {module:model/IngressTrunkModify.RpidIdTypeEnum} rpid_id_type
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.PassThroughEnum} pass_through
   * @default 'transparent'
   */
  exports.prototype['pass_through'] = 'transparent';
  /**
   * @member {module:model/IngressTrunkModify.BypassMediaEnum} bypass_media
  ...
  /**
   * @member {module:model/IngressTrunkModify.RpidEnum} rpid
   * @default 'Never'
   */
  ...
  /**
   * @member {module:model/IngressTrunkModify.RpidScreenEnum} rpid_screen
   * @default 'None'
   */
