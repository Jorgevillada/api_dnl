...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.DailyCdrFieldGet = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The DailyCdrFieldGet model module.
   * @module model/DailyCdrFieldGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>DailyCdrFieldGet</code>.
   * @alias module:model/DailyCdrFieldGet
   * @class
   */
  ...
  /**
   * Constructs a <code>DailyCdrFieldGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DailyCdrFieldGet} obj Optional instance to populate.
   * @return {module:model/DailyCdrFieldGet} The populated <code>DailyCdrFieldGet</code> instance.
   */
