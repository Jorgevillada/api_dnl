...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EgressTrunkPass'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EgressTrunkPass'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.InlineResponse20026 = factory(root.DnlApi.ApiClient, root.DnlApi.EgressTrunkPass);
  }
}(this, function(ApiClient, EgressTrunkPass) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) {
        obj['payload'] = EgressTrunkPass.constructFromObject(data['payload']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/EgressTrunkPass} payload
   */
