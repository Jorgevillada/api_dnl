...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.Failover = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The Failover model module.
   * @module model/Failover
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>Failover</code>.
   * @alias module:model/Failover
   * @class
   */
  ...
  /**
   * Constructs a <code>Failover</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Failover} obj Optional instance to populate.
   * @return {module:model/Failover} The populated <code>Failover</code> instance.
   */
  ...
  /**
   * @member {module:model/Failover.FailoverMethodEnum} failover_method
