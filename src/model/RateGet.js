...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.RateGet = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The RateGet model module.
   * @module model/RateGet
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>RateGet</code>.
   * @alias module:model/RateGet
   * @class
   * @param codeName {String} 
   * @param rate {Number} 
   */
  var exports = function(codeName, rate) {
    var _this = this;
  ...
  /**
   * Constructs a <code>RateGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RateGet} obj Optional instance to populate.
   * @return {module:model/RateGet} The populated <code>RateGet</code> instance.
   */
