...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.ResourcePrefixModify = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The ResourcePrefixModify model module.
   * @module model/ResourcePrefixModify
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>ResourcePrefixModify</code>.
   * @alias module:model/ResourcePrefixModify
   * @class
  ...
  /**
   * Constructs a <code>ResourcePrefixModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResourcePrefixModify} obj Optional instance to populate.
   * @return {module:model/ResourcePrefixModify} The populated <code>ResourcePrefixModify</code> instance.
   */
