...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SignupIpGet'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SignupIpGet'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.SignupGet = factory(root.DnlApi.ApiClient, root.DnlApi.SignupIpGet);
  }
}(this, function(ApiClient, SignupIpGet) {
  'use strict';
  ...
  /**
   * The SignupGet model module.
   * @module model/SignupGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>SignupGet</code>.
   * @alias module:model/SignupGet
   * @class
  ...
  /**
   * Constructs a <code>SignupGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SignupGet} obj Optional instance to populate.
   * @return {module:model/SignupGet} The populated <code>SignupGet</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ip_address')) {
        obj['ip_address'] = ApiClient.convertToType(data['ip_address'], [SignupIpGet]);
      }
  ...
  /**
   * @member {Array.<module:model/SignupIpGet>} ip_address
   */
  ...
  /**
   * @member {module:model/SignupGet.StatusEnum} status
   * @default 'new'
   */
  exports.prototype['status'] = 'new';
  /**
   * @member {Number} id
   */
