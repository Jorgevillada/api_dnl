...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.CarrierModify = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The CarrierModify model module.
   * @module model/CarrierModify
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>CarrierModify</code>.
   * @alias module:model/CarrierModify
   * @class
   */
  ...
  /**
   * Constructs a <code>CarrierModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarrierModify} obj Optional instance to populate.
   * @return {module:model/CarrierModify} The populated <code>CarrierModify</code> instance.
   */
  ...
  /**
   * @member {module:model/CarrierModify.DailyUsageGroupByEnum} daily_usage_group_by
   * @default 'By Country'
   */
  ...
  /**
   * @member {module:model/CarrierModify.ProfitTypeEnum} profit_type
   * @default 'percentage'
   */
  ...
  /**
   * @member {module:model/CarrierModify.AutoInvoiceTypeEnum} auto_invoice_type
   * @default 'buy'
   */
