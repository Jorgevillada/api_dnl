...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.GlobalFailoverModify = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The GlobalFailoverModify model module.
   * @module model/GlobalFailoverModify
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>GlobalFailoverModify</code>.
   * @alias module:model/GlobalFailoverModify
   * @class
   */
  ...
  /**
   * Constructs a <code>GlobalFailoverModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GlobalFailoverModify} obj Optional instance to populate.
   * @return {module:model/GlobalFailoverModify} The populated <code>GlobalFailoverModify</code> instance.
   */
  ...
  /**
   * @member {module:model/GlobalFailoverModify.FailoverMethodEnum} failover_method
