...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.SendRateDirectGet = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The SendRateDirectGet model module.
   * @module model/SendRateDirectGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>SendRateDirectGet</code>.
   * @alias module:model/SendRateDirectGet
   * @class
   */
  ...
  /**
   * Constructs a <code>SendRateDirectGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendRateDirectGet} obj Optional instance to populate.
   * @return {module:model/SendRateDirectGet} The populated <code>SendRateDirectGet</code> instance.
   */
  ...
  /**
   * @member {module:model/SendRateDirectGet.DownloadMethodEnum} download_method
   * @default 'send as link'
   */
  exports.prototype['download_method'] = 'send as link';
  /**
   * @member {Array.<module:model/SendRateDirectGet.HeadersEnum>} headers
   */
