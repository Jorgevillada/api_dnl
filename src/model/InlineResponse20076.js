...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SystemParameterSystemTimeouts'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SystemParameterSystemTimeouts'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.InlineResponse20076 = factory(root.DnlApi.ApiClient, root.DnlApi.SystemParameterSystemTimeouts);
  }
}(this, function(ApiClient, SystemParameterSystemTimeouts) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) {
        obj['payload'] = SystemParameterSystemTimeouts.constructFromObject(data['payload']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/SystemParameterSystemTimeouts} payload
   */
