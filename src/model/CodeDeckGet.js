...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.CodeDeckGet = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The CodeDeckGet model module.
   * @module model/CodeDeckGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>CodeDeckGet</code>.
   * @alias module:model/CodeDeckGet
   * @class
   */
  ...
  /**
   * Constructs a <code>CodeDeckGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CodeDeckGet} obj Optional instance to populate.
   * @return {module:model/CodeDeckGet} The populated <code>CodeDeckGet</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('code_count')) {
        obj['code_count'] = ApiClient.convertToType(data['code_count'], 'Number');
      }
  ...
  /**
   * @member {Number} code_count
   */
  exports.prototype['code_count'] = undefined;
  /**
   * @member {String} name
   */
