...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.CarrierTemplateModify = factory(root.DnlApi.ApiClient, root.DnlApi.CarrierTemplateLowBalConfig);
  }
  ...
  /**
   * The CarrierTemplateModify model module.
   * @module model/CarrierTemplateModify
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>CarrierTemplateModify</code>.
   * @alias module:model/CarrierTemplateModify
   * @class
   */
  ...
  /**
   * Constructs a <code>CarrierTemplateModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarrierTemplateModify} obj Optional instance to populate.
   * @return {module:model/CarrierTemplateModify} The populated <code>CarrierTemplateModify</code> instance.
   */
  ...
  /**
   * @member {module:model/CarrierTemplateModify.ProfitTypeEnum} profit_type
   * @default 'percentage'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateModify.ModeEnum} mode
   * @default 'prepay'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateModify.AutoDailyBalanceRecipientEnum} auto_daily_balance_recipient
  ...
  /**
   * @member {module:model/CarrierTemplateModify.FormatEnum} format
   * @default 'PDF'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateModify.SccTypeEnum} scc_type
  ...
  /**
   * @member {module:model/CarrierTemplateModify.AutoSummaryGroupByEnum} auto_summary_group_by
   * @default 'By Country'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateModify.CdrFormatEnum} cdr_format
   * @default 'Excel'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateModify.RateValueEnum} rate_value
   * @default 'null'
   */
