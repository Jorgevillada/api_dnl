...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20090Payload'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20090Payload'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.InlineResponse20090 = factory(root.DnlApi.ApiClient, root.DnlApi.InlineResponse20090Payload);
  }
}(this, function(ApiClient, InlineResponse20090Payload) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) {
        obj['payload'] = InlineResponse20090Payload.constructFromObject(data['payload']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse20090Payload} payload
   */
