...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.TrunkTemplate = factory(root.DnlApi.ApiClient, root.DnlApi.TrunkTemplateIp);
  }
  ...
  /**
   * The TrunkTemplate model module.
   * @module model/TrunkTemplate
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>TrunkTemplate</code>.
   * @alias module:model/TrunkTemplate
   * @class
  ...
  /**
   * Constructs a <code>TrunkTemplate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TrunkTemplate} obj Optional instance to populate.
   * @return {module:model/TrunkTemplate} The populated <code>TrunkTemplate</code> instance.
   */
  ...
  /**
   * @member {module:model/TrunkTemplate.RpidPrivacyEnum} rpid_privacy
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/TrunkTemplate.RpidPartyEnum} rpid_party
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/TrunkTemplate.RpidScreenEnum} rpid_screen
   * @default 'None'
   */
  ...
  /**
   * @member {module:model/TrunkTemplate.TrunkTypeEnum} trunk_type
   * @default 'Ingress'
   */
  ...
  /**
   * @member {module:model/TrunkTemplate.ProfitTypeEnum} profit_type
   * @default 'percentage'
   */
  ...
  /**
   * @member {module:model/TrunkTemplate.RpidIdTypeEnum} rpid_id_type
   * @default 'None'
   */
  exports.prototype['rpid_id_type'] = 'None';
  /**
   * @member {module:model/TrunkTemplate.ResStrategyEnum} res_strategy
   * @default 'top-down'
   */
  ...
  /**
   * @member {module:model/TrunkTemplate.MediaTypeEnum} media_type
