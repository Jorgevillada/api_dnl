...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.GlobalRouteError = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The GlobalRouteError model module.
   * @module model/GlobalRouteError
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>GlobalRouteError</code>.
   * @alias module:model/GlobalRouteError
   * @class
   */
  ...
  /**
   * Constructs a <code>GlobalRouteError</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GlobalRouteError} obj Optional instance to populate.
   * @return {module:model/GlobalRouteError} The populated <code>GlobalRouteError</code> instance.
   */
