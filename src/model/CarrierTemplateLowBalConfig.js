...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.CarrierTemplateLowBalConfig = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The CarrierTemplateLowBalConfig model module.
   * @module model/CarrierTemplateLowBalConfig
   * @version 1.2.10
   */

  /**
   * Constructs a new <code>CarrierTemplateLowBalConfig</code>.
   * @alias module:model/CarrierTemplateLowBalConfig
   * @class
   */
  ...
  /**
   * Constructs a <code>CarrierTemplateLowBalConfig</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CarrierTemplateLowBalConfig} obj Optional instance to populate.
   * @return {module:model/CarrierTemplateLowBalConfig} The populated <code>CarrierTemplateLowBalConfig</code> instance.
   */
  ...
  /**
   * @member {module:model/CarrierTemplateLowBalConfig.SendTimeTypeEnum} send_time_type
   * @default 'daily'
   */
  ...
  /**
   * @member {module:model/CarrierTemplateLowBalConfig.ValueTypeEnum} value_type
