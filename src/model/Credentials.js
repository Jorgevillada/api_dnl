...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.Credentials = factory(root.DnlApi.ApiClient);
  }
   ...
   * @class
   * @param emailOrName {String} 
   * @param password {String} 
   */
  var exports = function(emailOrName, password) {
    var _this = this;

    _this['email_or_name'] = emailOrName;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('email_or_name')) {
        obj['email_or_name'] = ApiClient.convertToType(data['email_or_name'], 'String');
      }
  ...
  /**
   * @member {String} email_or_name
   */
  exports.prototype['email_or_name'] = undefined;
  /**
