...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse200104Payload'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse200104Payload'));
  } else {
    // Browser globals (root is window)
    if (!root.DnlApi) {
      root.DnlApi = {};
    }
    root.DnlApi.InlineResponse200104 = factory(root.DnlApi.ApiClient, root.DnlApi.InlineResponse200104Payload);
  }
}(this, function(ApiClient, InlineResponse200104Payload) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) {
        obj['payload'] = InlineResponse200104Payload.constructFromObject(data['payload']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse200104Payload} payload
   */
