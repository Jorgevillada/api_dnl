...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.GlobalRouteErrorGet = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The GlobalRouteErrorGet model module.
   * @module model/GlobalRouteErrorGet
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>GlobalRouteErrorGet</code>.
   * @alias module:model/GlobalRouteErrorGet
   * @class
   */
  ...
  /**
   * Constructs a <code>GlobalRouteErrorGet</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GlobalRouteErrorGet} obj Optional instance to populate.
   * @return {module:model/GlobalRouteErrorGet} The populated <code>GlobalRouteErrorGet</code> instance.
   */
