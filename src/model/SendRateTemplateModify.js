...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DnlApi.SendRateTemplateModify = factory(root.DnlApi.ApiClient);
  }
  ...
  /**
   * The SendRateTemplateModify model module.
   * @module model/SendRateTemplateModify
   * @version 1.2.62
   */

  /**
   * Constructs a new <code>SendRateTemplateModify</code>.
   * @alias module:model/SendRateTemplateModify
   * @class
   */
  ...
  /**
   * Constructs a <code>SendRateTemplateModify</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendRateTemplateModify} obj Optional instance to populate.
   * @return {module:model/SendRateTemplateModify} The populated <code>SendRateTemplateModify</code> instance.
   */
  ...
  /**
   * @member {module:model/SendRateTemplateModify.DownloadMethodEnum} download_method
  ...
  /**
   * @member {Array.<module:model/SendRateTemplateModify.HeadersEnum>} headers
   */
